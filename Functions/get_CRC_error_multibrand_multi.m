function [error, fails, results, imagenes] = get_CRC_error_multibrand_multi(imagenes, data,  maskx1, maskx2, masky1, masky2, I, bkg_voi, pixel_sizes, FWHM, zfilter, brand, EARL_mode, half_life);
...
%im_filt = filtra_3D(imagen, pixel_sizes, [FWHM FWHM 0]);
if(strcmp(brand,'GE'))
